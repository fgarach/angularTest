...
public class Sujet implements Serializable {
    ...
    private Utilisateur posteParUtil;

    public Utilisateur getPosteParUtil() {
        return posteParUtil;
    }

    public void setPosteParUtil(Utilisateur posteParUtil) {
        this.posteParUtil = posteParUtil;
    }
    ...
    @OneToMany(mappedBy = "appartientAuSujet")
